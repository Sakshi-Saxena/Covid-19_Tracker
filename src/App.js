  ...
  render(){
    ...
    return (
      ...
      <Box className={this.props.classes.container}> 
        <Box className={this.props.classes.header}>CORONAVIRUS (COVID-19) TRACKER </Box>
        ...
        <Chart data={data} />
        <h3 style={{opacity: ".8", fontFamily: "sans-serif", fontSize: "16px"}}>Made by Sakshi Saxena <span style={{color: "red"}}>❤</span></h3>
      </Box>
